...
// Job search and AI-powered resume compatibility analysis API
public class JobMatchController {
    ...
    // Triggers AI analysis: fetches resume from resume-service, calls Gemini for compatibility scoring
    @PostMapping("/analyze")
    ...
    // Debug endpoint — exposes raw Jooble API response. Consider gating behind @Profile("dev")
