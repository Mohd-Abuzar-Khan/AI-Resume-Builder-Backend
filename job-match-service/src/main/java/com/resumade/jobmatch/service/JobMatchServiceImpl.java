...
@Service
// Aggregates job listings from Jooble API and provides AI-powered resume-to-job compatibility analysis
public class JobMatchServiceImpl implements JobMatchService {
    ...
    // NOTE: Delegates to fetchJobsFromJooble despite method name suggesting LinkedIn source
    @Override
    ...
    // WARNING: API key embedded in URL path — visible in logs and network traces
    ...
    // Fetches resume from resume-service, sends both to Gemini for compatibility scoring
    @Override
    @Transactional
    ...
    // Duplicated Gemini call logic from ai-service — consider extracting to shared library
