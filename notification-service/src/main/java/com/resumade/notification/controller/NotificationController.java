...
// Notification API — user inbox, read status, and admin broadcast
public class NotificationController {
    ...
    // WARNING: No auth/RBAC — broadcast is public in gateway, anyone can push notifications to all users
    ...
    public ResponseEntity<Void> sendTestEmail(@RequestParam String email) {
