...
@Component
// Per-request JWT filter — validates token signature, expiry, AND Redis session existence
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                // Dual validation: JWT cryptographic check + Redis session lookup (rejects logged-out tokens)
