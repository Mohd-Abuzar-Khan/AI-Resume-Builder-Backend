...
// Razorpay payment API — order creation, verification, and webhook handling
public class PaymentController {
    ...
    // Uses untyped Map instead of a DTO — no input validation on Razorpay fields
    @PostMapping("/verify")
    ...
    // WARNING: Webhook is a no-op — Razorpay events (payment.captured, refund) are silently dropped
    @PostMapping("/webhook")
