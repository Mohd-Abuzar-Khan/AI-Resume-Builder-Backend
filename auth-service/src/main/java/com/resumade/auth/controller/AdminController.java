...
public class AdminController {
    ...
    public ResponseEntity<Void> promoteToAdmin(@PathVariable("id") Integer id) {
    ...
    @GetMapping("/payments")
    public ResponseEntity<List<com.resumade.auth.dto.AdminPaymentDTO>> getAllPayments() {
        return ResponseEntity.ok(authService.getAllPayments());
    }
}
