...
class AdminControllerTest {
    ...
    @BeforeEach
    void setUp() {
        User user1 = new User("John", "john@test.com", "hash", User.Role.USER, User.Provider.LOCAL, true, User.SubscriptionPlan.FREE);
        user1.setUserId(1);
        User user2 = new User("Jane", "jane@test.com", "hash", User.Role.ADMIN, User.Provider.GOOGLE, true, User.SubscriptionPlan.PREMIUM);
        user2.setUserId(2);
