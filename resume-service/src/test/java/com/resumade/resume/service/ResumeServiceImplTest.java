...
import com.resumade.resume.dto.*;
...
class ResumeServiceImplTest {
    ...
    void createResume_shouldSaveResume() {
        ...
        ResumeResponse result = resumeService.createResume(1, "FREE", request);
    ...
    void createResume_shouldAllowPremiumUnlimited() {
        ...
        ResumeResponse result = resumeService.createResume(1, "PREMIUM", request);
        assertNotNull(result);
    }
    ...
    void getResumeById_shouldReturnResumeForOwner() {
        ...
        ResumeResponse result = resumeService.getResumeById(1, 1);
    ...
    void getResumeById_shouldReturnPublicResumeAndIncrementViews() {
        ...
        ResumeResponse result = resumeService.getResumeById(1, 2);
    ...
    void getUserResumes_shouldReturnList() {
        ...
        List<ResumeResponse> result = resumeService.getUserResumes(1);
    ...
    void getPublicResumes_withQuery_shouldReturnList() {
        ...
        List<ResumeResponse> result = resumeService.getPublicResumes("java");
        assertEquals(1, result.size());
    }
    ...
    void getPublicResumes_withoutQuery_shouldReturnList() {
        ...
        List<ResumeResponse> result = resumeService.getPublicResumes(null);
        assertEquals(1, result.size());
    }
    ...
    void updateResume_shouldUpdateAndSave() {
        ...
        ResumeResponse result = resumeService.updateResume(1, 1, request);
    ...
    void duplicateResume_shouldCreateCopy() {
        ...
        ResumeResponse result = resumeService.duplicateResume(1, 1, "FREE");
    ...
    void publishResume_shouldSetPublic() {
        ...
        ResumeResponse result = resumeService.publishResume(1, 1, true, "Owner", "Avatar");
    ...
    void publishResume_shouldSetCompleteWhenNotPublic() {
        ...
        ResumeResponse result = resumeService.publishResume(1, 1, false, "Owner", "Avatar");
    ...
    void addSection_shouldSaveSection() {
        ...
        SectionResponse result = resumeService.addSection(1, 1, request);
        assertNotNull(result);
    }
    ...
    void updateSection_shouldUpdate() {
        ...
        SectionResponse result = resumeService.updateSection(1, 1, request);
        assertEquals("New Title", result.getTitle());
    }
    ...
    void toggleSectionVisibility_shouldToggle() {
        ...
        SectionResponse result = resumeService.toggleSectionVisibility(1, 1, false);
