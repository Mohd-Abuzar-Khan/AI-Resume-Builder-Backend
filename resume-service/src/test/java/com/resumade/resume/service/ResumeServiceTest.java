...
class ResumeServiceTest {
    ...
    void duplicateResume_CoppiesAllSections() {
        ...
        ResumeResponse result = resumeService.duplicateResume(originalId, userId, "PREMIUM");
    ...
    void searchPublicResumes_ReturnsFilteredResults() {
        ...
        mockResume.setResumeId(1);
        when(resumeRepository.searchPublicResumes(query)).thenReturn(Arrays.asList(mockResume));
