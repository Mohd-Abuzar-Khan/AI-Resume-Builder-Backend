package com.resumade.resume.security;
...
@Component
// JWT filter for resume-service — trusts gateway-injected X-User-Id for
// internal calls
public class JwtAuthFilter extends OncePerRequestFilter {
        ...
        if (authHeader == null || !authHeader.startsWith("Bearer ")) {
            ...
            if (xUserId != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                UsernamePasswordAuthenticationToken authToken = new UsernamePasswordAuthenticationToken(
                        "internal-user-" + xUserId, null, new ArrayList<>());
    ...
    private Claims extractClaims(String token) {
        ...
        // JwtService does: BASE64_decode(BASE64_encode(secret.getBytes())) =
        // secret.getBytes()
