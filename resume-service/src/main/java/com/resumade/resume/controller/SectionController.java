...
// Section CRUD API — manages individual sections within a resume (add, update, delete, reorder, toggle)
...
public class SectionController {
    ...
    public ResponseEntity<SectionResponse> addSection(
        ...
        SectionResponse created = resumeService.addSection(resumeId, userId, request);
