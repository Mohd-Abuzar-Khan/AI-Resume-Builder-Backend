...
class TemplateServiceImplTest {
    ...
    void getAllActiveTemplates_shouldReturnList() {
        ...
        List<Template> result = templateService.getAllActiveTemplates();
    ...
    void getFreeTemplates_shouldReturnList() {
        ...
        List<Template> result = templateService.getFreeTemplates();
        assertEquals(1, result.size());
    }
    ...
    void getPremiumTemplates_shouldReturnList() {
        ...
        List<Template> result = templateService.getPremiumTemplates();
        assertEquals(1, result.size());
    }
    ...
    void getTemplatesByCategory_shouldReturnList() {
        ...
        List<Template> result = templateService.getTemplatesByCategory("PROFESSIONAL");
        assertEquals(1, result.size());
    }
    ...
    void getPopularTemplates_shouldReturnList() {
        ...
        List<Template> result = templateService.getPopularTemplates();
        assertEquals(1, result.size());
    }
    ...
    void getTemplateById_shouldReturnTemplate() {
        ...
        Template result = templateService.getTemplateById(1);
    ...
    void createTemplate_shouldSaveTemplate() {
        ...
        Template result = templateService.createTemplate(request, "ADMIN");
    ...
    void updateTemplate_shouldUpdateAndSave() {
        ...
        Template result = templateService.updateTemplate(1, request, "ADMIN");
        assertNotNull(result);
    }
